  ...
  const newsItems = [
    {
      ...
      date: "January 2024",
      description: "Our latest awareness campaign in schools across Kolkata has successfully educated over 1000 students about mental health and emotional well-being.",
    ...
    },
    {
      ...
      date: "December 2023",
      description: "Featured in The Times of India discussing early intervention strategies and identification of developmental challenges in children.",
    ...
    },
    {
      ...
      category: "Press Release",
      date: "November 2023",
      description: "Introducing our new comprehensive workplace mental health program designed to support employees and organizations.",
    ...
    },
    {
      ...
      category: "Article",
      date: "October 2023",
      description: "Exploring how community-based interventions contribute significantly to mental health recovery and social integration.",
    ...
    },
    {
      ...
      category: "Press Release",
      date: "September 2023",
      description: "Expanding our 24/7 mental health helpline to underserved rural communities across Eastern India.",
    ...
    },
    {
      ...
      category: "Article",
      date: "August 2023",
      description: "Medical professionals share insights on anxiety disorders, treatment options, and coping strategies.",
      image: "https://images.unsplash.com/photo-1579154204601-01d5f6011d21?w=400&h=300&fit=crop"
    },
  ];
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {newsItems.map((news) => (
              <div key={news.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow group">
                {/* Image */}
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Subscribe to receive updates about our programs, research, and impact stories
          </p>
